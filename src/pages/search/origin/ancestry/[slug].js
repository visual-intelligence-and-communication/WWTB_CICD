import { getAncestryInstitution } from "@/utils/database/grist";
...
export async function getServerSideProps({ params: { slug } }) {
  ...
  const data = await getAncestryInstitution({ slug });
...
//   try {
//     const ancestries = await getAncestry();
//     const paths = ancestries
//       .map((it) => ({
