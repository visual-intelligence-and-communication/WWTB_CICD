...
const ListCircleForLegend2 = ({value, valueOfInstitution, maxValue, outside}) => {
    ...
    useEffect(() => {
        ...
        let node = rc.circle(112/2, 112/2 , size,{
            fill: outside ? ROUGHJS_COLORS.fill : ROUGHJS_COLORS.acc,
            fillWeight: 1,
            strokeWidth: 1,
            stroke: ROUGHJS_COLORS.fill,
            roughness: 0.8
        });
        let lNode = rc.line(112/2, 112/2 - size/2, 112/2 + legendDistance, 112/2 - size/2,{
        ...
        .style("font-size", 11)
        .text(outside ? "Remains Count" : "Result Total")
...
export default ListCircleForLegend2;